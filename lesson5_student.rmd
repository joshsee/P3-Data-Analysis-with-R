...
```{r Ratio Plot}
library(ggplot2)
ggplot(aes(x=age, y=female/male), data=pf.fc_by_age_gender.wide) + geom_line() + geom_hline(y=1)
```
...
ggplot(yo, aes(x=price)) + geom_histogram(bin=10)
```
