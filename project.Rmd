...
I decided to plot out ggpairs to have a look into the relationships. I found out that the top 4 most correclated variables with quality were alcohol, ph, sulphates, citric.acid
...
p2 <- ggplot(aes(x = quality_category, y = pH), data = wines) +
      geom_boxplot() +
      ggtitle('Quality vs ph')

p3 <- ggplot(aes(x = quality_category, y = sulphates), data = wines) +
      geom_boxplot() +
      ggtitle('Quality vs Sulphates')

p4 <- ggplot(aes(x = quality_category, y = citric.acid), data = wines) +
      geom_boxplot() +
      ggtitle('Quality vs Sulphates')
