...
wines$quality_numeric <- as.numeric(wines$quality)
cor.test(wines$fixed.acidity, wines$quality_numeric, method='pearson')

cor.test(subset(wines, 4 <= fixed.acidity & fixed.acidity <= 12), quality, method = 'p'))

cor.test(wines$volatile.acidity, wines$quality_numeric, method='pearson')    
cor.test(wines$citric.acid, wines$quality_numeric, method='pearson')    
cor.test(wines$residual.sugar, wines$quality_numeric, method='pearson')
cor.test(wines$chlorides, wines$quality_numeric, method='pearson')           
cor.test(wines$free.sulfur.dioxide, wines$quality_numeric, method='pearson')  
cor.test(wines$total.sulfur.dioxide, wines$quality_numeric, method='pearson') 
cor.test(wines$density, wines$quality_numeric, method='pearson')             
cor.test(wines$pH, wines$quality_numeric, method='pearson')                   
cor.test(wines$sulphates, wines$quality_numeric, method='pearson')            
cor.test(wines$alcohol, wines$quality_numeric, method='pearson')
