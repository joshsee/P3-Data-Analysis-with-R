...
cor(wines$fixed.acidity, wines$quality_numeric)
cor(wines$volatile.acidity, wines$quality_numeric)    
cor(wines$citric.acid, wines$quality_numeric)    
cor(wines$residual.sugar, wines$quality_numeric)       
cor(wines$chlorides, wines$quality_numeric)           
cor(wines$free.sulfur.dioxide, wines$quality_numeric)  
cor(wines$total.sulfur.dioxide, wines$quality_numeric) 
cor(wines$density, wines$quality_numeric)             
cor(wines$pH, wines$quality_numeric)                   
cor(wines$sulphates, wines$quality_numeric)            
cor(wines$alcohol, wines$quality_numeric)
